...
const selectedEvents = [
  ...
  },
  {
    ...
    body: "For Avedon 100 with Gagosian Gallery at Boom Boom Room, I curated the soundtrack for a cocktail event that called for taste, restraint, and just the right amount of movement. I was recommended to the Director of Events at Gagosian by The Standard’s event sales team, which made the booking feel especially aligned from the start. With a guest list spanning fashion, art, and culture, including names like Anna Wintour, Gigi Hadid, and Naomi Campbell, the goal was to create an atmosphere that felt elevated and alive without ever pulling focus from the room itself. The soundtrack supported conversation, complemented the setting, and carried the evening with a polished sense of momentum from start to finish. The event was later featured in Vanity Fair and Vogue, with both publications noting B.Mills among the DJs behind the evening.",
  },
  {
    title: "School of American Ballet Ball",
    meta: "Dinner + Dancing | Lincoln Center, New York City",
    body: "Trusted for two consecutive years to soundtrack the School of American Ballet Ball at Lincoln Center, I shaped the full musical arc of the evening for approximately 450 guests, including high-net-worth donors and dance enthusiasts. I was referred to the School of American Ballet by the New York City Ballet Young Patrons Circle event team, following 13 years of DJing their Young Patrons Circle post-performance parties at the David H. Koch Theater at Lincoln Center. The night began with a smooth, soulful dinner soundtrack that brought warmth and movement into the room while keeping the tone elegant. From there, the energy built naturally into a more celebratory dance floor later in the evening, allowing the event to shift without losing its sense of polish.",
  },
];
