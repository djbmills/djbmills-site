    ...
    <div className="min-h-screen bg-[#000000] text-[#f5f5f7] selection:bg-neutral-800 selection:text-white">
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 border-b border-neutral-900 bg-[#000000]">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="font-body text-base text-neutral-400 leading-relaxed mt-5 font-light">
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 border-b border-neutral-900 bg-[#000000]">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.p
            ...
            viewport={{ once: true, margin: '-10%' }}
            transition={{ duration: 0.9, ease: [0.25, 0.1, 0.25, 1], delay: 0.35 }}
            className="font-body text-base text-neutral-400 leading-relaxed max-w-3xl font-light"
          >
          ...
          >
            <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-8 lg:gap-12 items-start">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="font-body text-base text-neutral-400 leading-relaxed mt-8 font-light">
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 border-b border-neutral-900 bg-[#050505]">
        <div className="max-w-4xl mx-auto">
          ...
          >
            At the highest level, the music is only part of it. B.MILLS is fully insured and experienced in working alongside venue and production teams, bringing a calm, understated presence to brand events, executive dinners, and large-scale galas where timing, tone, and room flow all matter.
          </motion.p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="border border-neutral-900">
                <img
                  ...
                  alt="B.MILLS Luxury Corporate Event and Brand Activation DJ NYC Boom Boom Room"
              ...
              <div className="border border-neutral-900">
                <img
                  ...
                  alt="B.MILLS Curated Brand Activation DJ Music Direction for High End Galas"
                  className="w-full h-full object-cover opacity-85"
                />
              </div>
            </div>
      ...
      <InquiryFooter
        ...
        body="High-stakes brand events require a precise soundtrack. Share your event details and let's discuss the direction."
        footerText={
          <>
