...
const DESKTOP_IMAGE =
  '/images/nyc-brand-activation-dj-citi-union-square.webp';

const MOBILE_IMAGE =
  '/images/nyc-brand-activation-dj-citi-union-square-mobile.webp';

export default function BrandActivationHero() {
  ...
  return (
    <section
      ref={ref}
      className="relative w-full pt-16 md:pt-20 pb-14 md:pb-16 px-6 md:px-12 border-b border-border bg-[#f0eeeb] overflow-hidden"
    >
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <div className="flex flex-col justify-between md:items-end md:pt-6 md:pb-6">
            ...
            >
              Brand Activation Music Director
            </motion.p>
            ...
            >
              Music direction and curated DJ sets for experiential campaigns,
              product launches, branded environments, and cultural events
        ...
        <motion.div
          ...
          className="relative w-full mt-8 md:mt-9 overflow-hidden bg-black/5 aspect-[4/5] md:aspect-[2048/1365]"
        >
          <motion.div
          ...
          >
            <img
              src={DESKTOP_IMAGE}
              alt="B.MILLS performing for the Citi Summer in the Square brand activation in Union Square, New York City"
              fetchPriority="high"
              decoding="async"
          ...
          <p className="absolute left-5 bottom-5 md:left-8 md:bottom-7 font-body text-[9px] md:text-[10px] tracking-[0.28em] uppercase text-white/65">
            Citi Summer in the Square | Union Square, NYC
          </p>
        </motion.div>
