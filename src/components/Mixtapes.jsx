    ...
    <section id="mixtapes" className="py-24 md:py-36 px-6 md:px-12 bg-foreground">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="font-heading text-4xl md:text-6xl font-light text-background">
            Mixtape Mode
          </h2>
          <p className="font-body text-sm text-background/50 mt-4">
          ...
          {mixtapes.map((tape, i) => (
            ...
            >
              <div className="relative aspect-square overflow-hidden mb-6">
                <img
                  src={tape.image}
                  alt={`${tape.title} mixtape cover by B.MILLS DJ`}
