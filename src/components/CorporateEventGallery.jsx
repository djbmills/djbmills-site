...
const photos = [
  { src: 'https://media.base44.com/images/public/69c5d6df4095d84ce47a4bc2/cb856c29f_DoradoBeachRainandRoseFundBenefit1.jpg', alt: 'Premier corporate event DJ at formal gala New York City', caption: 'Carlos Delgado and Carlos Beltran speak at fundraiser event for Puerto Rico' },
  { src: 'https://media.base44.com/images/public/69c5d6df4095d84ce47a4bc2/2ba902b0f_BEAZLEY_NYC_MARCH2023_PHOTOBY_LARUFOTO_LUISRUIZ_000073.jpg', alt: 'DJ B.MILLS performing at client corporate event NYC', caption: 'Client event atmosphere', credit: true },
  { src: 'https://media.base44.com/images/public/69c5d6df4095d84ce47a4bc2/37a7490df_corporate-event-cocktail-reception-Group-shot-w-DJ.jpg', alt: 'B.MILLS with guests at corporate cocktail reception', caption: 'Corporate cocktail reception group shot' },
];
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 border-b border-border" style={{ backgroundColor: '#f3eee2' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-16">
            <div className="flex items-center gap-4 mb-10 overflow-hidden">
              ...
              <motion.span className="font-body text-xs tracking-[0.3em] uppercase text-muted-foreground">In the Room</motion.span>
            </div>

            <h2 className="font-heading text-5xl md:text-6xl font-light text-foreground mb-4 leading-tight">
              The Work
            </h2>
        ...
        <AnimatePresence>
          {lightboxIndex !== null && (
            ...
            >
              ...
              className="font-body text-xs tracking-[0.3em] uppercase text-muted-foreground">In the Room</motion.span>
          </div>
          <div className="overflow-hidden">
            <motion.h2
              ...
              className="font-heading text-5xl md:text-6xl font-light text-foreground mb-4 leading-tight">The Work</motion.h2>
          </div>
          <motion.p
            ...
            className="font-body text-sm text-muted-foreground">Moments from corporate events across New York and beyond.</motion.p>
        </div>
        ...
        <div className="grid md:grid-cols-5 gap-3 md:gap-4">
          ...
          >
            ...
            <p className="font-body text-xs text-muted-foreground mt-3 tracking-wide">{photos[0].caption}</p>
          </motion.div>
                  ...
                  {photo.credit && (
                    <div className="absolute bottom-3 right-3 opacity-0 group-hover:opacity-70 transition-opacity duration-300">
                      <p className="font-body text-xs font-light text-white tracking-wide">
                        Photo by{' '}
                        <a href="https://www.instagram.com/larufoto/" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-80 transition-opacity" onClick={(e) => e.stopPropagation()}>Luis</a>
                      </p>
                    </div>
                  )}
                </div>
                <p className="font-body text-xs text-muted-foreground mt-3 tracking-wide">{photo.caption}</p>
              </motion.div>
            ))}
          </div>
        </div>
