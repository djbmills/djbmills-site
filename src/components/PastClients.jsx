...
const clients = [
'CELINE', 'Gucci', 'LVMH', 'Moët & Chandon',
'Kering Eyewear', 'L\'Oréal', 'Supreme', 'Tumi',
'Goldman Sachs', 'JP Morgan Chase', 'Fanatics', 'Google',
'New York City Ballet', 'Gagosian Gallery', 'The Standard Hotels', 'Equinox',
'NBCUniversal', 'Disney', 'Mass Appeal', 'MLB'];
      ...
      <motion.div style={{ y }} className="max-w-7xl mx-auto relative">
        <div className="flex items-center gap-4 mb-16 overflow-hidden">
          ...
          <motion.span
            ...
            className="font-body text-xs tracking-[0.3em] uppercase text-muted-foreground">Clients</motion.span>
        </div>
        <motion.div
          ...
          className="mb-16">
          <h2 className="font-heading text-4xl md:text-6xl font-light text-foreground mb-4">In Good Company</h2>
          <p className="font-body text-xs tracking-[0.3em] uppercase text-muted-foreground">Selected clients across fashion, finance, media, and culture</p>
        </motion.div>
